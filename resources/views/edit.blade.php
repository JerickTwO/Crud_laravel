            ...
            <div class="col-xs-12 col-sm-12 col-md-6 mt-2">
                <div class="form-group">
                    ...
                    <select name="status" class="form-select" id="">
                        ...
                        {{-- Comprueba en la base de datos si esta el texto y si esta pues lo imprime como value --}}
                        ...
                        <option value="Completado" @selected("Completado" == $task->status) > Completada</option>
                    </select>
                </div>
            </div>
